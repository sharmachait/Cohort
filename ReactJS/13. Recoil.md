...
why? because the components would otherwise first render the default value and then over write it with the value they get from the useEffect and but the end user would be able to see the default data
