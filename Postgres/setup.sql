...
INSERT INTO product(type_id,name,supplier,description) VALUES(3,'kanye','nike','WHATT DISKNEE, NAIKEEE, GOOOGOOO');
INSERT INTO product(type_id,name,supplier,description) VALUES(3,'easterneuropean','addidas','WHATT DISKNEE, NAIKEEE, GOOOGOOO');
INSERT INTO product(type_id,name,supplier,description) VALUES(3,'big pharma','benzo diazapenes','i am not gonna say what race, what color people the doctor was');
INSERT INTO product(type_id,name,supplier,description) VALUES(3,'kanye','nike','WHATT DISKNEE, NAIKEEE, GOOOGOOO');
INSERT INTO product(type_id,name,supplier,description) VALUES(3,'easterneuropean','addidas','WHATT DISKNEE, NAIKEEE, GOOOGOOO');
INSERT INTO product(type_id,name,supplier,description) VALUES(3,'big pharma','benzo diazapenes','i am not gonna say what race, what color people the doctor was');
INSERT INTO product(type_id,name,supplier,description) VALUES(3,'kanye','nike','WHATT DISKNEE, NAIKEEE, GOOOGOOO');
...
ALTER TABLE sales_person ALTER COLUMN company DROP NOT NULL;
